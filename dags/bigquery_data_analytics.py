...
default_arguments = {"owner": "", "start_date": days_ago(1)}
...
with DAG(
    ...
    create_cluster = DataprocClusterCreateOperator(
        ...
        project_id="ca-airflow-tutorial-demo",
        cluster_name="spark-cluster-{{ ds_nodash }}",
        num_workers=2,
        storage_bucket="ca-logistics-spark-bucket",
    ...
    weekend_analytics = DataProcPySparkOperator(
        ...
        main="gs://ca-logistics-spark-bucket/pyspark/weekend/gas_composition_count.py",
        cluster_name="spark-cluster-{{ ds_nodash }}",
