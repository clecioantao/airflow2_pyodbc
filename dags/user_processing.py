...
with  DAG('user_processing', schedule_interval='@daily', default_args=default_args, catchup=False, tags=['curso1', 'marc']) as dag:
    ...
    storing_user = BashOperator(
        ...
        bash_command='echo -e ".separator ","\n.import /opt/airflow/dags/processed_user.csv users" | sqlite3 /opt/airflow/airflow.db'
    )

    creating_table >> is_api_available >> extract_user >> processing_user >> storing_user
